' ==================================================================*
'  Pongo Video Cutter - Strongly-Typed Settings Generator
'  -----------------------------------------------------------------
...
' -----------------------------------------------------------------
'  Auto-generated wrapper around My.Settings. Persists the FFmpeg/
'  FFprobe paths, recent files list, last folder and window size/
